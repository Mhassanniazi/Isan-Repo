    ...
    <section className="w-full py-[93px] bg-[#F2F2F2]">
      <div className="myContainer flex">
        <div className="w-[48%]">
          ...
          <a>
          <Link href="/contact">
            <button className="fgr text-bold w-[332px] h-[79px] flex justify-between items-center bg-[#AE8B5C] text-[24px] text-[#fff] rounded-[50px] px-[30px] py-[10px] hover:opacity-[.8]">
              Get started 
