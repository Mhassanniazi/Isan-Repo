  ...
  return (
    <section className="text-[#fff] pt-[40px] md:pt-[75px] pb-[50px] md:pb-[80px] relative overflow-hidden">
      ...
      <div className="myContainer relative z-[2]">
        ...
        <div className="flex flex-row flex-wrap justify-between gap-x-[0] xl:gap-x-[1.5%] gap-y-[30px] xl:gap-y-0 mt-[30px] md:mt-[65px]">
          <div className='xl:w-[31%] md:w-[20%]  md:w-[220px] apporch-card    flex'>
