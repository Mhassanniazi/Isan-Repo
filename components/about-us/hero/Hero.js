...
const Hero = () => {
  return (
    <>
      <Link href="/contact">
        <a className="fgb text-[#fff] text-[14px] leading-[42px] bg-[#AB8353] w-full flex md:hidden justify-center items-center h-[40px] md:h-[35px] pt-[3px]">
          Get Started
      ...
      <section className="w-full pt-[22px] pb-[30px] md:py-[93px] bg-[#F2F2F2] relative overflow-hidden">
        ...
        <div className="myContainer flex flex-col-reverse flex r-flex-row lg:flex-row  relative z-[1]">
          <div className="w-full lg:w-[79% ] lg:w-[60%] main-about-banner">
            ...
            >
              ...
              perfection, constituting thclse highest form of worship.
            </p>
