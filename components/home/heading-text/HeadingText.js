  ...
  return (
    <section className="pt-[40px] md:pt-[79px] pb-[43px] md:pb-[85px]">
      <div className="myContainer text-center">
        <h2 className="fpr mb-[17px] md:mb-[49px] text-[32px] sm:text-[32px] md:text-[65px] text-[#0F2E3C]   mx-auto leading-[32px] md:leading-[65px]  ">
          Coaching through the
          <br /> lens of culture
        </h2>
        <p className="fgr text-[#292929] text-[15px] md:text-[16px] lg:text-[18px] leading-[16px] md:leading-[26px] max-w-[865px] mx-auto">
        ...
        <p className="fgr text-[#292929] text-[16px] md:text-[16px] lg:text-[18px] leading-[16px] md:leading-[26px] max-w-[865px] mx-auto mt-[20px]">
        ...
        <Link href="/contact">
          <a className="fgr block mx-auto w-[140px] md:w-[178px] h-[45px] pt-[10px]  md:h-[50px] bg-[#AE8B5C] text-[#fff] text-[16px] md:text-[16px] rounded-[50px] px-[17px] md:px-[30px] py-[6px] md:py-[13px] mt-[18px] md:mt-[40px] hover:opacity-[.8] cursor-pointer">
            Get Started
          </a>
        </Link>
      </div>
